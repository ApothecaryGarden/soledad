...
function pencidesign_customizer_css() {
    ...
    <style type="text/css">
		...
		.footer-instagram h4.footer-instagram-title > span:before, .woocommerce nav.woocommerce-pagination ul li span.current, .penci-pagination.penci-ajax-more a.penci-ajax-more-button:hover { border-color: <?php echo get_theme_mod( 'penci_color_accent' ); ?>; }
