...
function pencidesign_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting( 'penci_remove_hatom_data', array(
		'default'           => false,
		'sanitize_callback' => 'penci_sanitize_checkbox_field'
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'remove_hatom_data', array(
		'label'    => 'Remove Hatom Data Markup',
		'section'  => 'pencidesign_new_section_general',
		'settings' => 'penci_remove_hatom_data',
		'type'     => 'checkbox',
		'priority' => 60
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'home_featured_cat_seemore', array(
		'label'    => 'Enable "See All" button for Featured Categories in Magazine Layouts',
		'section'  => 'pencidesign_new_section_homepage',
